...
const TYPE_CONFIG = {
  ...
  message: { icon: MessageCircle, color: "#2E7D32", bg: "#E8F5E9", emoji: "💬" },
  payment: { icon: DollarSign, color: "#E65100", bg: "#FFF3E0", emoji: "💰" },
  tip: { icon: Info, color: "#2E7D32", bg: "#E8F5E9", emoji: "🌱" },
  warning: { icon: Info, color: "#E65100", bg: "#FFF3E0", emoji: "⚠️" },
  alert: { icon: Info, color: "#C62828", bg: "#FFEBEE", emoji: "🚨" },
...
const DEMO_NOTIFICATIONS = [
  ...
  },
  {
    ...
    type: "weather",
    title: "Weather Alert",
    message: "Heavy rain expected tomorrow morning. Delay irrigation and protect seedlings.",
    is_read: false,
  ...
  },
  {
    ...
    message: "Driver James is on the way with your order #1034. ETA: 45 minutes.",
    is_read: true,
  ...
  },
  {
    ...
    message: "KSh 4,800 received via M-Pesa for order #1029. Funds available now.",
    is_read: true,
  ...
  },
  {
    ...
    type: "tip",
    title: "Farming Tip",
    message: "Tomato prices in Nairobi market up 12% this week. Good time to sell!",
    is_read: true,
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setNotifications(fetched.length > 0 ? fetched : DEMO_NOTIFICATIONS);
      } else {
  ...
  if (!auth) {
    return (
      ...
      >
        ...
        >
          <Text style={{ color: "white", fontFamily: "Poppins_700Bold", fontSize: 16 }}>
            Sign In
          </Text>
        </TouchableOpacity>
      </View>
    ...
    <View style={{ flex: 1, backgroundColor: "#F0F4F0" }}>
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text
              style={{ fontSize: 20, fontFamily: "Poppins_700Bold", color: "white" }}
            >
              Notifications
            </Text>
            {unread > 0 && (
      ...
      >
        {loading ? (
          <ActivityIndicator color="#2E7D32" size="large" style={{ marginTop: 60 }} />
        ) : filtered.length === 0 ? (
          <View style={{ alignItems: "center", marginTop: 80 }}>
            <Bell size={48} color="#DDD" style={{ marginBottom: 12 }} />
            <Text style={{ fontSize: 16, fontFamily: "Poppins_600SemiBold", color: "#999" }}>
